...
#
#
# generateTOVtemplate.sh - Creates the file structure for processing EOS's.
#
...
#
# History:
# Version 0.1: 2014/04/285 (rsouza) - Creating the file...
#
...
_TOV_EXECUTABLE="FORTRAN_TOV_Solver"
...
print2stringslncolor "Creating symbolic links..."

ln -s -r ${_TOV_EXECUTABLE} ${_OUTPUT_DIR}/${_TOV_EXECUTABLE}
...
cp chain.sh ${_OUTPUT_DIR}/
cp generate_Output.sh ${_OUTPUT_DIR}/scripts
cp massaRaio.gnuplot ${_OUTPUT_DIR}/scripts
cp massaRho.gnuplot ${_OUTPUT_DIR}/scripts
cp tov.sh ${_OUTPUT_DIR}/scripts
cp tov_solver_template.conf ${_OUTPUT_DIR}/tov_solver.conf
